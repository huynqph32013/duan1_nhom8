        ...
        <div class="card">
          <div class="card-body p-4">
            ...
            <div class="row">
              ...
              <div class="col-lg-7">
                <h5 class="mb-3"><a href="?act=allsp" class="text-body"><i class="fas fa-long-arrow-alt-left me-2"></i>Trở Lại</a></h5>
                <hr>

                <div class="d-flex justify-content-between align-items-center mb-4">
                  <div>
                    <p class="mb-1">Yuhn Shop</p>
                    <p class="mb-0">Bạn Có <?php echo count($_SESSION['myhd']) + count($_SESSION['comb']) ?> Đơn Hàng</p>
                  </div>
                  <div>
                ...
                <div class="card bg-primary text-white rounded-3">
                  <div class="card-body">
                    ...
                    <form class="mt-4" method="post" action="?act=cfbill">
                      ...
                      <div class="form-outline form-white mb-4">
                        <input type="text" id="typeText" class="form-control form-control-lg" siez="17" placeholder="Số điện thoại" minlength="19" name="numberphone" maxlength="19" value="<?php echo $sdt ?>" />
                      ...
                      <div class="form-outline form-white mb-4">
                        <input type="text" id="typeText" class="form-control form-control-lg" siez="17" placeholder="Địa Chỉ" minlength="19" name="address" maxlength="19" value="<?php echo $diachi ?>" />
