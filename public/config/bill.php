    ...
    <div class="row d-flex justify-content-center align-items-center h-100">
      <div class="col">
        <div class="card">
          <div class="card-body p-4">
            ...
            <div class="row">
              ...
              <div class="col-lg-7">
                <h5 class="mb-3"><a href="?act=allsp" class="text-body"><i
                      class="fas fa-long-arrow-alt-left me-2"></i>Trở Lại</a></h5>
                <hr>

                <div class="d-flex justify-content-between align-items-center mb-4">
                  <div>
                    <p class="mb-1">Yuhn Shop</p>
                    <p class="mb-0">Bạn Có <?php echo count($_SESSION['myhd'])?> Đơn Hàng</p>
                  </div>
                  <div>
            ...
            ?>
                ...
                <div class="row">
                    ...
                    <div class="col-2"></div>
                    <div class="col-5"><p>Tổng Tiền :</p> <?php echo number_format($ttien)?> VND</div>
        ...
        if(isset($_SESSION['checkus'])){
            ...
            $fulname = $_SESSION['checkus']['fullname'];
                ...
                <div class="card bg-primary text-white rounded-3">
                  <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                      ...
                      <img src="../uploads/<?php echo $_SESSION['checkus']['image']?>"
                        class="img-fluid rounded-3" style="width: 45px;" alt="Avatar">
                    </div>

                    <p class="small mb-2">Card type</p>
                    <a href="#!" type="" class="text-white"><i
                    ...
                    <form class="mt-4" method="post" action="?act=cfbill">
                      <div class="form-outline form-white mb-4">
                        <input type="text" id="typeName" class="form-control form-control-lg" name="hoten" value="<?php echo $fulname?>" siez="17"
                      ...
                      <div class="form-outline form-white mb-4">
                        <input type="text" id="typeText" class="form-control form-control-lg" siez="17"
                          placeholder="Số điện thoại" minlength="19" name="numberphone" maxlength="19" value="<?php echo $sdt?>"/>
                        ...
                        <div class="col-md-6">
                          <div class="form-outline form-white">
                            <input type="text" id="typeExp" class="form-control form-control-lg"
                              placeholder="Email" size="7" id="exp" name="mail"  value="<?php echo $email?>" minlength="7" maxlength="7" />
                      ...
                      <div class="form-outline form-white mb-4">
                        <input type="text" id="typeText" class="form-control form-control-lg" siez="17"
                          placeholder="Địa Chỉ" minlength="19" name="address" maxlength="19" value="<?php echo $diachi?>"/>
